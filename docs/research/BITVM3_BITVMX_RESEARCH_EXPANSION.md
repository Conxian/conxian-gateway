...
- **BitVMX-GC is not an integration target yet.** The BitVMX platform has public design material and describes GC/DV-SNARK support as coming in 2026, but no stable public API, release, or reproducible integration target was verified. The historical `/blog/implementing-garbled-circuits-for-bitvmx` URL returned HTTP 404 on 2026-07-21; the current article is [`/knowledge/implementing-garbled-circuits-for-bitvmx`](https://bitvmx.org/knowledge/implementing-garbled-circuits-for-bitvmx), verified on 2026-07-22.
- **BitVMX has an upstream Bitcoin mainnet SNARK prototype record.** The official BitVMX article links transaction [`75eb2ad4f22263440fc4ceb61c51b0bb77721661dbfbec961358520b04107ec3`](https://mempool.space/tx/75eb2ad4f22263440fc4ceb61c51b0bb77721661dbfbec961358520b04107ec3). It is prototype evidence for interactive SNARK-verifier execution, not BitVM3-GC, a stable SDK, a production bridge, a Conxian verifier, or audit evidence.
...
| [BitVMX GC article](https://bitvmx.org/knowledge/implementing-garbled-circuits-for-bitvmx) | Current URL verified 2026-07-22; historical `/blog/implementing-garbled-circuits-for-bitvmx` URL returned HTTP 404 on 2026-07-21 | Current article describes the BitVMX-GC/DV-SNARK architecture and client-integration intent. | **verified**, high for article availability/content; implementation maturity **unknown** | Design/article evidence; no versioned stable GC API or release | Article does not establish a GC implementation license | Design claims are not Conxian measurements. |
| [BitVMX SNARK prototype article](https://bitvmx.org/knowledge/a-new-era-for-bitcoin-successful-snark-proof-verification-with-bitvmx) and [mainnet transaction](https://mempool.space/tx/75eb2ad4f22263440fc4ceb61c51b0bb77721661dbfbec961358520b04107ec3) | Accessed 2026-07-22; article links the transaction as an interactive SNARK-verifier execution on Bitcoin mainnet | Upstream prototype evidence for BitVMX execution. | **verified**, high for article/transaction links; protocol/security significance **upstream-reported** | Prototype transaction; not a stable SDK or production bridge | Article does not establish a production software license | Not BitVM3-GC, not a Conxian verifier, and not audit evidence. |
...
- BitVMX has public platform prose for GC and a 2026 target statement, but no stable public GC revision, release, or narrow API was verified. The historical GC article URL returned 404 on 2026-07-21; the current `/knowledge/` article was verified on 2026-07-22.
- The BitVMX SNARK prototype article and linked Bitcoin transaction are real upstream mainnet prototype evidence, but they do not establish BitVM3-GC, a stable SDK, a production bridge, or a Conxian verifier.

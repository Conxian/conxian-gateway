...
**Historical state as of July 22, 2026:** `FilePersistence` coordinated
`load()` and `save()` calls that shared the
...
See `docs/PERSISTENCE_TOPOLOGY.md` for the current CON-1548 transactional
boundary.

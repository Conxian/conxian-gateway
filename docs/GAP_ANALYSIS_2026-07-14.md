...
> hyperbola mismatch evidence, and seven supported rejection checks. It does
> not satisfy the full fixture/readiness gate and does not change the
> production-status assessment above.

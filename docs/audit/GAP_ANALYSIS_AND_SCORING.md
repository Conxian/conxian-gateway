...
| **G-C5** | Canton CCIP message authenticity verification | Canton | 🟡 Route schema exists; production routing is fail-closed until a Chainlink message verifier is configured |

...
const FIAT_WEBHOOK_SECRET_SENTINEL: &str = "REQUIRED_FOR_PROD_FIAT_WEBHOOK_SECRET";
const SETTLEMENT_INGRESS_SECRET_SENTINEL: &str = "REQUIRED_FOR_PROD_SETTLEMENT_INGRESS_SECRET";
const API_TOKEN_SENTINEL: &str = "REQUIRED_FOR_PROD_API_TOKEN";
const RAMP_API_KEY_SENTINEL: &str = "REQUIRED_FOR_PROD_RAMP_API_KEY";
const INVESTEC_CLIENT_ID_SENTINEL: &str = "REQUIRED_FOR_PROD_INVESTEC_CLIENT_ID";
const INVESTEC_SECRET_SENTINEL: &str = "REQUIRED_FOR_PROD_INVESTEC_SECRET";
const ALCHEMY_PAY_APP_ID_SENTINEL: &str = "REQUIRED_FOR_PROD_ALCHEMY_PAY_APP_ID";
const ALCHEMY_PAY_SECRET_SENTINEL: &str = "REQUIRED_FOR_PROD_ALCHEMY_PAY_SECRET";
const BANXA_API_KEY_SENTINEL: &str = "REQUIRED_FOR_PROD_BANXA_API_KEY";
